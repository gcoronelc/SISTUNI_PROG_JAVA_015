...
public class MainView extends javax.swing.JFrame {
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        menuArchivoSalir.setMnemonic('s');
        ...
        menuGenio.setMnemonic('g');
        menuGenio.setText("Estadística");

        menuMedia.setMnemonic('f');
        ...
        menuGenio.add(menuMedia);

        menuMediana.setMnemonic('m');
        ...
        menuGenio.add(menuMediana);

        menuModa.setMnemonic('c');
  ...
  private void menuMediaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuMediaActionPerformed
    cargarFormulario(MediaView.class);
  ...
  private void menuModaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuModaActionPerformed
    cargarFormulario(ModaView.class);
    ...
    cargarFormulario(MedianaView.class);
  ...
  private void cargarFormulario(Class<?> aClass) {
    try{
      ...
      // Buscar instancia en el desktopPane
