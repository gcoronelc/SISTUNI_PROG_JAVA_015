...
public class CompView extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "DATO", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.ABOVE_TOP));
    ...
    jPanel3Layout.setHorizontalGroup(
      ...
      .addGroup(jPanel3Layout.createSequentialGroup()
        ...
        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          ...
          .addComponent(btnCerrar, javax.swing.GroupLayout.DEFAULT_SIZE, 133, Short.MAX_VALUE))
        .addContainerGap())
    );
  ...
  private void btnProcesarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcesarActionPerformed
    ...
    try {
      ...
      tabla.setRowCount(0);
      for (Item i : repo) {
        Object[] rowData = {i.getConcepto(), i.getValor()};
        tabla.addRow(rowData);
      }
    } catch(NullPointerException e){
      JOptionPane.showMessageDialog(rootPane, 
              "Debes selecionar un tipo");
